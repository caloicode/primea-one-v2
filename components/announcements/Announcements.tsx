...
import MinutesForm from "./AnnouncementForm";
import DeleteMinutesDialog from "./DeleteAnnouncementDialog";
import {
  DropdownMenu,
  DropdownMenuTrigger,
  DropdownMenuContent,
...
export default function Announcements() {
  const [minutes, setMinutes] = useState<(Announcement & { user: User | null })[]>(
    []
  );
  const [allUsers, setAllUsers] = useState<User[]>([]);
  const [dialogOpen, setDialogOpen] = useState(false);
  const [editMinute, setEditMinute] = useState<Announcement | null>(null);
